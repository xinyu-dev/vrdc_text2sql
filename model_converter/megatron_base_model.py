...
class MegatronBaseModel(NLPModel):
    ...
    def _build_tokenizer(self):
        ...
        self.tokenizer = AutoTokenizer(pretrained_model_name="/lustrefs/users/hvnguyen/base_models/Mistral-NeMo-Minitron-8B-Instruct")
    ...
    def build_model_parallel_config(self) -> ModelParallelConfig:
        ...
        mp_config_dict["sequence_parallel"] = False
        print(mp_config_dict)
